...
| **线上站（edit.chaxus.com）** | `playwright.prod.config.ts` + `.github/workflows/prod-smoke.yml`（每日 04:47 + 手动；核心 8 个 spec，1 worker）；也可 `E2E_BASE_URL=https://edit.chaxus.com` 跑任意 spec；首跑发现慢链路首存超时（已修）                                          |
| Chromium                      | 全部                                                                                                                                                                                                                                              |
| WebKit / Firefox              | ⬜                                                                                                                                                                                                                                                |
| 视觉基线（L3）                | ⬜                                                                                                                                                                                                                                                |
