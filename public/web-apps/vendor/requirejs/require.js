...
(function (global) {
      ...
      (req = requirejs =
        function (e, t, i, r) {
          var n,
            ...
            o = defContextName;
          return (
            isArray(e) || 'string' == typeof e || ((a = e), isArray(t) ? ((e = t), (t = i), (i = r)) : (e = [])),
            a && a.context && (o = a.context),
            (n = getOwn(contexts, o)) || (n = contexts[o] = req.s.newContext(o)),
            a && n.configure(a),
            n.require(e, t, i)
          );
        }),
  ...
  function newContext(e) {
    var t,
      ...
      n,
      a,
      o = { waitSeconds: 7, baseUrl: './', paths: {}, bundles: {}, pkgs: {}, shim: {}, config: {} },
      s = {},
      c = {},
      u = {},
      p = [],
    ...
    function g(e, t, i) {
      ...
      if (
        (e &&
          ...
          (t
            ? ((m = h.slice(0, h.length - 1)),
              ...
              o.nodeIdCompat && jsSuffixRegExp.test(e[u]) && (e[u] = e[u].replace(jsSuffixRegExp, '')),
              (function (e) {
                var t,
                  i,
                  r = e.length;
        ...
        e: for (a = (n = e.split('/')).length; a > 0; a -= 1) {
          if (((c = n.slice(0, a).join('/')), h))
            for (s = h.length; s > 0; s -= 1)
              if ((r = getOwn(g, h.slice(0, s).join('/'))) && (r = getOwn(r, c))) {
                ((p = r), (d = a));
                break e;
              }
          !f && v && getOwn(v, c) && ((f = getOwn(v, c)), (l = a));
        }
        (!p && f && ((p = f), (d = l)), p && (n.splice(0, d, p), (e = n.join('/'))));
      }
          ...
          (u
            ? (v =
                o && o.normalize
                  ...
                  : g(e, p, n))
            : ((u = (c = b((v = g(e, p, n))))[0]), (v = c[1]), (i = !0), (a = r.nameToUrl(v)))),
        {
          prefix: u,
          name: v,
          parentMap: t,
          unnormalized: !!(s = !u || o || i ? '' : '_unnormalized' + (m += 1)),
          url: a,
          originalName: f,
          isDefine: l,
          id: (u ? u + '!' + v : v) + s,
    ...
    function w(e, t, i) {
      var r = e.id,
        n = getOwn(s, r);
      !hasProp(d, r) || (n && !n.defineEmitComplete)
        ? (n = E(e)).error && 'error' === t
          ? i(n.error)
          : n.on(t, i)
        : 'defined' === t && i(d[r]);
    ...
    function S() {
      globalDefQueue.length && (apsp.apply(p, [p.length, 0].concat(globalDefQueue)), (globalDefQueue = []));
    }
    function k(e) {
      ...
      e.error
        ...
        : ((t[r] = !0),
          each(e.depMaps, function (r, n) {
            var a = r.id,
              o = getOwn(s, a);
            !o || e.depMatched[n] || i[a] || (getOwn(t, a) ? (e.defineDep(n, d[a]), e.check()) : O(o, t, i));
          }),
          (i[r] = !0));
    }
    function M() {
        ...
        if (
          ...
          eachProp(c, function (e) {
            ...
            if (e.enabled && (t.isDefine || p.push(e), !e.error))
              if (!e.inited && s) x(r) ? ((i = !0), (d = !0)) : (u.push(r), v(r));
              else if (!e.inited && e.fetched && t.isDefine && ((d = !0), !t.prefix)) return (f = !1);
          }),
          s && u.length)
        )
          return (
            ((e = makeError('timeout', 'Load timeout for modules: ' + u, null, u)).contextName = r.contextName),
            y(e)
          );
        (f &&
          each(p, function (e) {
    ...
    function j(e) {
      hasProp(d, e[0]) || E(q(e[0], null, !0)).init(e[1], e[2]);
    }
    function P(e, t, i, r) {
    ...
    return (
      (n = {
        ...
        exports: function (e) {
          if (((e.usingExports = !0), e.map.isDefine)) return e.exports ? e.exports : (e.exports = d[e.map.id] = {});
        },
        module: function (e) {
          return e.module
            ? e.module
              ...
              if (this.error) this.emit('error', this.error);
                ...
                if (((this.defining = !0), this.depCount < 1 && !this.defined)) {
                  if (isFunction(o)) {
                    ...
                    else a = r.execCb(i, o, n, a);
                    if (
                      (this.map.isDefine &&
                        void 0 === a &&
                        ((t = this.module) ? (a = t.exports) : this.usingExports && (a = this.exports)),
                      e)
                    )
                      return (
                  ...
                  ((this.exports = a),
                    this.map.isDefine &&
                      !this.ignore &&
                      ((d[i] = a), req.onResourceLoad && req.onResourceLoad(r, this.map, this.depMaps)),
                    k(i),
                    (this.defined = !0));
                }
                ((this.defining = !1),
              ...
              bind(this, function (i) {
                ...
                return this.map.unnormalized
                  ? (i.normalize &&
                    ...
                    w(
                      (a = q(e.prefix + '!' + p, this.map.parentMap)),
                      'defined',
                  ...
                  : u
                    ? ((this.map.url = r.nameToUrl(u)), void this.load())
                    : (((n = bind(this, function (e) {
                      ...
                      (n.fromText = bind(this, function (i, a) {
                        ...
                        (u && (useInteractive = !0), this.depMaps.push(c), r.completeLoad(s), f([s], n));
                      })),
                      void i.load(e.name, f, n, o));
              }),
            ),
            r.enable(i, this),
          ...
          ((c[this.map.id] = this),
            ...
            each(
              ...
              bind(this, function (e, t) {
                ...
                if ('string' == typeof e) {
                  if (
                    ((e = q(e, this.map.isDefine ? this.map : this.map.parentMap, !1, !this.skipMap)),
                    (this.depMaps[t] = e),
                    (o = getOwn(n, e.id)))
                  )
                  ...
                  ((this.depCount += 1),
                    ...
                    this.errback && w(e, 'error', bind(this, this.errback)));
                }
                ((i = e.id), (a = s[i]), hasProp(n, i) || !a || a.enabled || r.enable(e, this));
              }),
            ),
            eachProp(
              this.pluginMaps,
      ...
      (r = {
            ...
            e.packages &&
              each(e.packages, function (e) {
                ...
                ((t = (e = 'string' == typeof e ? { name: e } : e).name),
                  e.location && (o.paths[t] = e.location),
                  (o.pkgs[t] =
                    e.name + '/' + (e.main || 'main').replace(currDirRegExp, '').replace(jsSuffixRegExp, '')));
              }),
            eachProp(s, function (e, t) {
              e.inited || e.map.unnormalized || (e.map = q(t));
            }),
        ...
        makeRequire: function (t, i) {
          function a(o, c, u) {
            var p, f;
            return (
              i.enableBuildCallback && c && isFunction(c) && (c.__requireJsBuild = !0),
              'string' == typeof o
                ? isFunction(c)
                  ? y(makeError('requireargs', 'Invalid require call'), u)
                  : t && hasProp(n, o)
                    ? n[o](s[t.id])
                    : req.get
                      ? req.get(r, o, t, a)
                ...
                : (A(),
                  r.nextTick(function () {
                    (A(), ((f = E(q(null, t))).skipMap = i.skipMap), f.init(o, c, u, { enabled: !0 }), M());
                  }),
                  a)
            );
          }
          return (
            ...
            mixin(a, {
              ...
              defined: function (e) {
                return hasProp(d, q(e, t, !1, !0).id);
              },
              specified: function (e) {
                return ((e = q(e, t, !1, !0).id), hasProp(d, e) || hasProp(s, e));
              },
            }),
            t ||
              (a.undef = function (e) {
                ...
                (v(e),
                  ...
                  delete f[i.url],
                  delete u[e],
                  eachReverse(p, function (t, i) {
                    t[0] === e && p.splice(i, 1);
                  }),
                  r && (r.events.defined && (u[e] = r.events), k(e)));
              }),
            a
          );
        },
        ...
        nameToUrl: function (e, t, i) {
          var n,
            ...
            p,
            d = getOwn(o.pkgs, e);
          if ((d && (e = d), (p = getOwn(l, e)))) return r.nameToUrl(p, t, i);
          if (req.jsExtRegExp.test(e)) c = e + (t || '');
          else {
            for (n = o.paths, s = (a = e.split('/')).length; s > 0; s -= 1)
              if ((u = getOwn(n, a.slice(0, s).join('/')))) {
                (isArray(u) && (u = u[0]), a.splice(0, s, u));
                break;
              }
            ((c = a.join('/')),
              (c =
                ('/' === (c += t || (/^data\:|\?/.test(c) || i ? '' : '.js')).charAt(0) || c.match(/^[\w\+\.\-]+:/)
                  ? ''
                  : o.baseUrl) + c));
          }
          return o.urlArgs ? c + (-1 === c.indexOf('?') ? '?' : '&') + o.urlArgs : c;
        },
        load: function (e, t) {
          req.load(r, e, t);
        },
