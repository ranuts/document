...
(function () {
  ...
  (function installAscDesktopEditor() {
    ...
    window.AscDesktopEditor = {
      ...
      endReporter:                   noop,
      GetDefaultCertificate:         function(cb) { if (typeof cb === 'function') cb(null); },
      getDictionariesPath:           noopEmpty,
      GetEncryptedHeader:            function(cb) { if (typeof cb === 'function') cb(''); },
      GetFontThumbnailHeight:        function() { return 0; },
      GetImageFormat:                noopEmpty,
      GetImageOriginalSize:          function(p, cb) { if (typeof cb === 'function') cb(0, 0); },
