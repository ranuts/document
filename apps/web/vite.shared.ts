...
export const rollupInputs = {
  ...
  zhCnDocx: resolve(__dirname, 'pages/zh-cn/docx/index.html'),
  zhCnXlsx: resolve(__dirname, 'pages/zh-cn/xlsx/index.html'),
  zhCnPptx: resolve(__dirname, 'pages/zh-cn/pptx/index.html'),
  zhCnCsv: resolve(__dirname, 'pages/zh-cn/csv/index.html'),
