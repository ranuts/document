...
(function (window, undefined) {
  ...
  AscFonts.HB_ShapeText = function (fontFile, text, features, script, direction, language, reader) {
    if (!hb_cache_languages[language]) hb_cache_languages[language] = g_native_engine['HB_LanguageFromString']();
    if (!fontFile['GetHBFont']()) fontFile['SetHBFont'](g_native_engine['HB_FontMalloc']());
    var data = g_native_engine['HB_ShapeText'](
      fontFile['GetFace'](),
      fontFile['GetHBFont'](),
      text.pointer,
      features,
    ...
    var fontPointer = reader.readPointer64();
  ...
  AscFonts.Hyphen_Word = function (lang, word) {
    var ret = g_native_engine['Hyphen_Word'](lang, word);
    return ret ? ret : [];
  };
  AscFonts.onLoadModule();
  AscFonts.onLoadModule();
  window['InitNativeTextMeasurer'] = function () {
    g_native_engine = CreateEmbedObject('CTextMeasurerEmbed');
  };
})(window, undefined);
