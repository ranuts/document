...
(function () {
  ...
  (function installAscDesktopEditor() {
    ...
    function getUrl(k) { var e = _map[k]; return e ? e.url : k; }
    function noop() {}
  ...
  (function suppressConnectionLost() {
    ...
    jq.length = 0;
    var MOCK = { $window: jq, close: function () {}, show: function () {}, hide: function () {}, remove: function () {} };
    function suppress(opts) {
      var msg = opts && opts.msg;
      return typeof msg === 'string' && (msg.indexOf('Connection is lost') !== -1 || msg.indexOf('error occurred during the work') !== -1);
    }
    var origAlert = ui.alert.bind(ui);
    ui.alert = function (opts) { return suppress(opts) ? MOCK : origAlert.apply(ui, arguments); };
    var origWarning = ui.warning && ui.warning.bind(ui);
    if (origWarning) ui.warning = function (opts) { return suppress(opts) ? MOCK : origWarning.apply(ui, arguments); };
  })();
})();
