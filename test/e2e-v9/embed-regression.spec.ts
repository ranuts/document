...
/**
 * Regression suite for the v9 build (OnlyOffice Personal vendor). It drives
 * the real editor through the embed postMessage API via embed-demo.html --
 * the exact scenarios that were verified manually during the v9 migration
 * and its issue sweep (docs/explorations/2026-08-11-v9-vendor-swap-*.md and
...
test.describe('v9 embed regression', () => {
